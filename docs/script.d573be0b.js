...
function checkInSight(className, toggleClass) {
  var fadeOutArticlesArray = document.getElementsByTagName(className);

  for (var i = 1; i <= fadeOutArticlesArray.length; i++) {
    var ArticleID = fadeOutArticlesArray[i - 1].id;
    var fadeOutArticle = fadeOutArticlesArray[i - 1];
    var heightWindow = window.innerHeight;
    var articleTop = fadeOutArticle.getBoundingClientRect().top;
    var difference = heightWindow - articleTop;
