...
})({"6FwWa":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "8d1f2e050d19c526";
"use strict";
...
var _inter = require("@fontsource-variable/inter");
...
const revealTargets = document.querySelectorAll('.section .container > *, .facts');
...
const screens = [
    ...document.querySelectorAll('.screens__item')
];
if (lightbox && screens.length) {
    ...
    lightbox.addEventListener('click', (event)=>{
        if (event.target === lightbox || event.target.classList.contains('lightbox__figure')) lightbox.close();
    });
...
},{"@fontsource-variable/inter":"kBNZM"}],"kBNZM":[function() {},{}]},["6FwWa","2xGku"], "2xGku", "parcelRequire7d3f", {})

//# sourceMappingURL=personal-website.0d19c526.js.map
