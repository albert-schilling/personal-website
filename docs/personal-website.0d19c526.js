...
})({"ecFdE":[function(require,module,exports,__globalThis) {
...
function checkInSight(className, toggleClass) {
    ...
    for(let i = 1; i <= fadeOutArticlesArray.length; i++){
        ...
        if (difference < 150) // console.log(`Article with ID "${ArticleID}" is not in sight.`);
        {
            if (!fadeOutArticle.classList.contains(toggleClass)) fadeOutArticle.classList.add(toggleClass);
        } else if (fadeOutArticle.classList.contains(toggleClass)) // console.log(`Article with ID "${ArticleID}" is in sight.`);
...
},{}]},["ecFdE","2xGku"], "2xGku", "parcelRequire7d3f", {})
